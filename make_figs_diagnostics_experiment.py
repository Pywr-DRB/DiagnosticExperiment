...
model_label_dict["nhmv10"] = "NHM"
model_label_dict["nwmv21"] = "NWM"
model_label_dict["nhmv10_withObsScaled"] = "hNHM"
model_label_dict["nwmv21_withObsScaled"] = "hNWM"

model_names = list(model_label_dict.keys())
for m in model_names:
    model_label_dict[f'pywr_{m}'] = rf"Pywr-{model_label_dict[m]}"
...
if __name__ == "__main__":
    ...
    # Need to provide the DRB_spatial folder and modify the make_DRB_map 
    # in order for this to work again.
